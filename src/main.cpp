...
// A special thank you note to João, creator of piggycoin who helped me build the first
// release of EuroKoin
...
//uint256 hashGenesisBlock("0x17123d76375bf82f6d28f7351eefc80565e91dbc6fef61549e6704a31e2d90b1");
//98b423e74005af6f8f23885b3a3cb1afc614df44794bf76673ee4992a0eea191
uint256 hashGenesisBlock("0x98b423e74005af6f8f23885b3a3cb1afc614df44794bf76673ee4992a0eea191");
...
const string strMessageMagic = "EuroKoin Signed Message:\n";
...
static const int64 nTargetTimespan = 4 * 60 * 60; // EuroKoin: 4 hours
static const int64 nTargetSpacing = 120; // EuroKoin: 2 minute blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 2000) { DiffMode = 2; }
        }
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eurokoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EuroKoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0937f2b4bca28863b3b80387fc4017455a845e8dace6fb376689626767a28c4d");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times - At Least 2 Dead in Harlem Building Collapse";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394662309; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1491403;

        if (fTestNet)
        {
            block.nTime    = 1394660349;
            block.nNonce   = 145428;
        }
        ...
        //assert(block.hashMerkleRoot == uint256("0xa0357cfdc6f072f75a8cfd441c30729782334d8260edfc219019ef2e6fe07b72"));
	//0xc1acfd5b6a8171606db50a852eb7aed0c6f926afa2ac79a8d3ba5b8284f6c232
	assert(block.hashMerkleRoot == uint256("0xc1acfd5b6a8171606db50a852eb7aed0c6f926afa2ac79a8d3ba5b8284f6c232"));
