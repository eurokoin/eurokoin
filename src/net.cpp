...
static const char *strDNSSeed[][2] = {
    {"first seed", "31.133.13.144"},
    {"eurokoinseed", "seed.eurokoin.com"},
    {"wemineeuk.com", "wemineeuk.com"},
    {"main", "37.187.238.113"},
 };
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EuroKoin is probably already running."), addrBind.ToString().c_str());
        else
